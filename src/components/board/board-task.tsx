...
export function BoardTask(props: TaskProps) {
  ...
  return (
    ...
    >
      <div className="group flex flex-col justify-between h-full p-3 border border-border rounded-xl shadow-sm bg-background/95">
        <div>
        ...
        <div className="flex justify-end">
          <span className="text-xs text-muted-foreground">{`${start}:00h - ${end}:00h`}</span>
        </div>
      </div>
    </div>
  );
